...
class ContactsViewController: UIViewController {
    ...
    lazy var phoneButton = ContactsViewController.createContactButton(title: "+998 90 345 37 26", iconName: "phone.fill", color: .systemGreen)
    lazy var telegramButton = ContactsViewController.createContactButton(title: "@tashkent_recycle", iconName: "paperplane.fill", color: .systemBlue)
    lazy var emailButton = ContactsViewController.createContactButton(title: "info@ecosphere@list.ru", iconName: "envelope.fill", color: .systemOrange)
    ...
    private func setupActions() {
        ...
        if #available(iOS 17.0, *) {
            registerForTraitChanges([UITraitUserInterfaceStyle.self]) { (vc: ContactsViewController, _) in
